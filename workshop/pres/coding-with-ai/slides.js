...
`<div class="center">
  ...
  <h1>867 Commits<br>in <span class="accent">92 Days</span></h1>
...
`<div class="center">
  ...
  <div style="display: flex; justify-content: center; margin: 1rem 0;">
    <svg width="460" height="460" viewBox="0 0 460 460">
      ...
      <!-- Connecting arcs -->
      <path d="M 300 80 A 140 140 0 0 1 380 160" fill="none" stroke="#c084fc" stroke-width="2.5" marker-end="url(#arrow-impl)" opacity="0.5"/>
      <path d="M 380 300 A 140 140 0 0 1 300 380" fill="none" stroke="#4ade80" stroke-width="2.5" marker-end="url(#arrow-debug)" opacity="0.5"/>
      <path d="M 160 380 A 140 140 0 0 1 80 300" fill="none" stroke="#f87171" stroke-width="2.5" marker-end="url(#arrow-test)" opacity="0.5"/>
      <path d="M 80 160 A 140 140 0 0 1 160 80" fill="none" stroke="#22d3ee" stroke-width="2.5" marker-end="url(#arrow-doc)" opacity="0.5"/>

      <!-- Phase nodes -->
      <!-- Document (top) -->
      <rect x="155" y="30" width="150" height="70" rx="16" fill="#12121a" stroke="#c084fc" stroke-width="2"/>
      <text x="230" y="58" text-anchor="middle" fill="#c084fc" font-size="13" font-weight="700" font-family="Inter, sans-serif">DOCUMENT</text>
      <text x="230" y="78" text-anchor="middle" fill="#8888a0" font-size="10" font-family="JetBrains Mono, monospace">PRDs, ADRs, specs</text>

      <!-- Implement (right) -->
      <rect x="320" y="195" width="135" height="70" rx="16" fill="#12121a" stroke="#4ade80" stroke-width="2"/>
      <text x="387" y="223" text-anchor="middle" fill="#4ade80" font-size="13" font-weight="700" font-family="Inter, sans-serif">IMPLEMENT</text>
      <text x="387" y="243" text-anchor="middle" fill="#8888a0" font-size="10" font-family="JetBrains Mono, monospace">feat() commits</text>

      <!-- Debug (bottom) -->
      <rect x="155" y="360" width="150" height="70" rx="16" fill="#12121a" stroke="#f87171" stroke-width="2"/>
      <text x="230" y="388" text-anchor="middle" fill="#f87171" font-size="13" font-weight="700" font-family="Inter, sans-serif">DEBUG / VERIFY</text>
      <text x="230" y="408" text-anchor="middle" fill="#8888a0" font-size="10" font-family="JetBrains Mono, monospace">fix() commits</text>

      <!-- Test (left) -->
      <rect x="5" y="195" width="135" height="70" rx="16" fill="#12121a" stroke="#22d3ee" stroke-width="2"/>
      <text x="72" y="223" text-anchor="middle" fill="#22d3ee" font-size="13" font-weight="700" font-family="Inter, sans-serif">TEST</text>
      <text x="72" y="243" text-anchor="middle" fill="#8888a0" font-size="10" font-family="JetBrains Mono, monospace">test() commits</text>

      <!-- Center label -->
      <text x="230" y="225" text-anchor="middle" fill="#7c5cff" font-size="16" font-weight="900" font-family="Inter, sans-serif">REPEAT</text>
      <text x="230" y="245" text-anchor="middle" fill="#8888a0" font-size="10" font-family="JetBrains Mono, monospace">every feature arc</text>
    </svg>
  </div>
</div>`,
...
`<div>
  ...
  <div style="display: flex; justify-content: center; margin: 1.5rem 0;">
    <svg width="760" height="300" viewBox="0 0 760 300">
      <style>
        .cl { fill: #6b6b80; font-family: 'JetBrains Mono', monospace; font-size: 10px; }
        .gl { stroke: #1e1e2e; stroke-width: 1; }
      </style>
      ...
      <line x1="48" y1="200" x2="730" y2="200" stroke="#3a3a4e" stroke-width="1.5"/>
      ...
      <!-- Feb: d3 f17 x8 t5 = 33 -->
      <rect x="55" y="196.5" width="60" height="3.5" rx="3" fill="#E05BF5" opacity="0.85"/>
      <rect x="55" y="176.8" width="60" height="19.7" fill="#5BF58C" opacity="0.9"/>
      <rect x="55" y="167.5" width="60" height="9.3" fill="#FF6B6B" opacity="0.9"/>
      <rect x="55" y="161.7" width="60" height="5.8" rx="3" fill="#5B9EF5" opacity="0.9"/>
      <text class="cl" x="85" y="216" text-anchor="middle">Feb</text>

      <!-- Apr 12: x4 = 4 -->
      <rect x="123" y="195.4" width="60" height="4.6" rx="3" fill="#FF6B6B" opacity="0.9"/>
      <text class="cl" x="153" y="216" text-anchor="middle">Apr 12</text>

      <!-- Apr 19: d4 f59 x75 = 138 -->
      <rect x="191" y="195.4" width="60" height="4.6" rx="3" fill="#E05BF5" opacity="0.85"/>
      <rect x="191" y="127.0" width="60" height="68.4" fill="#5BF58C" opacity="0.9"/>
      <rect x="191" y="40.1" width="60" height="86.9" rx="3" fill="#FF6B6B" opacity="0.9"/>
      <text class="cl" x="221" y="216" text-anchor="middle">Apr 19</text>

      <!-- Apr 26: d2 f22 x31 t5 = 60 -->
      <rect x="259" y="197.7" width="60" height="2.3" rx="3" fill="#E05BF5" opacity="0.85"/>
      <rect x="259" y="172.2" width="60" height="25.5" fill="#5BF58C" opacity="0.9"/>
      <rect x="259" y="136.3" width="60" height="35.9" fill="#FF6B6B" opacity="0.9"/>
      <rect x="259" y="130.5" width="60" height="5.8" rx="3" fill="#5B9EF5" opacity="0.9"/>
      <text class="cl" x="289" y="216" text-anchor="middle">Apr 26</text>

      <!-- May 3: d1 f11 x18 t2 = 32 -->
      <rect x="327" y="198.8" width="60" height="1.2" rx="3" fill="#E05BF5" opacity="0.85"/>
      <rect x="327" y="186.1" width="60" height="12.7" fill="#5BF58C" opacity="0.9"/>
      <rect x="327" y="165.2" width="60" height="20.9" fill="#FF6B6B" opacity="0.9"/>
      <rect x="327" y="162.9" width="60" height="2.3" rx="3" fill="#5B9EF5" opacity="0.9"/>
      <text class="cl" x="357" y="216" text-anchor="middle">May 3</text>

      <!-- May 10: d6 f36 x51 t2 = 95 -->
      <rect x="395" y="193.0" width="60" height="7.0" rx="3" fill="#E05BF5" opacity="0.85"/>
      <rect x="395" y="151.3" width="60" height="41.7" fill="#5BF58C" opacity="0.9"/>
      <rect x="395" y="92.2" width="60" height="59.1" fill="#FF6B6B" opacity="0.9"/>
      <rect x="395" y="89.9" width="60" height="2.3" rx="3" fill="#5B9EF5" opacity="0.9"/>
      <text class="cl" x="425" y="216" text-anchor="middle">May 10</text>

      <!-- May 17: d3 f31 x91 t1 = 126 -->
      <rect x="463" y="196.5" width="60" height="3.5" rx="3" fill="#E05BF5" opacity="0.85"/>
      <rect x="463" y="160.6" width="60" height="35.9" fill="#5BF58C" opacity="0.9"/>
      <rect x="463" y="55.1" width="60" height="105.5" fill="#FF6B6B" opacity="0.9"/>
      <rect x="463" y="53.9" width="60" height="1.2" rx="3" fill="#5B9EF5" opacity="0.9"/>
      <text class="cl" x="493" y="216" text-anchor="middle">May 17</text>

      <!-- May 24: d8 f28 x37 t4 = 77 -->
      <rect x="531" y="190.7" width="60" height="9.3" rx="3" fill="#E05BF5" opacity="0.85"/>
      <rect x="531" y="158.3" width="60" height="32.4" fill="#5BF58C" opacity="0.9"/>
      <rect x="531" y="115.4" width="60" height="42.9" fill="#FF6B6B" opacity="0.9"/>
      <rect x="531" y="110.8" width="60" height="4.6" rx="3" fill="#5B9EF5" opacity="0.9"/>
      <text class="cl" x="561" y="216" text-anchor="middle">May 24</text>

      <!-- May 31: d5 f23 x34 t1 = 63 -->
      <rect x="599" y="194.2" width="60" height="5.8" rx="3" fill="#E05BF5" opacity="0.85"/>
      <rect x="599" y="167.5" width="60" height="26.7" fill="#5BF58C" opacity="0.9"/>
      <rect x="599" y="128.1" width="60" height="39.4" fill="#FF6B6B" opacity="0.9"/>
      <rect x="599" y="126.9" width="60" height="1.2" rx="3" fill="#5B9EF5" opacity="0.9"/>
      <text class="cl" x="629" y="216" text-anchor="middle">May 31</text>

      <!-- Jun 7: d2 f7 x11 t6 = 26 -->
      <rect x="667" y="197.7" width="60" height="2.3" rx="3" fill="#E05BF5" opacity="0.85"/>
      <rect x="667" y="189.6" width="60" height="8.1" fill="#5BF58C" opacity="0.9"/>
      <rect x="667" y="176.8" width="60" height="12.8" fill="#FF6B6B" opacity="0.9"/>
      <rect x="667" y="169.9" width="60" height="6.9" rx="3" fill="#5B9EF5" opacity="0.9"/>
      <text class="cl" x="697" y="216" text-anchor="middle">Jun 7</text>

      <!-- Legend (matches loop order: docs → feat → fix → test) -->
      <rect x="170" y="240" width="14" height="14" rx="3" fill="#E05BF5" opacity="0.85"/>
      <text x="190" y="252" fill="#e4e4ef" font-size="12" font-family="Inter, sans-serif">docs</text>
      <rect x="250" y="240" width="14" height="14" rx="3" fill="#5BF58C" opacity="0.9"/>
      <text x="270" y="252" fill="#e4e4ef" font-size="12" font-family="Inter, sans-serif">feat</text>
      <rect x="325" y="240" width="14" height="14" rx="3" fill="#FF6B6B" opacity="0.9"/>
      <text x="345" y="252" fill="#e4e4ef" font-size="12" font-family="Inter, sans-serif">fix</text>
      <rect x="395" y="240" width="14" height="14" rx="3" fill="#5B9EF5" opacity="0.9"/>
      <text x="415" y="252" fill="#e4e4ef" font-size="12" font-family="Inter, sans-serif">test</text>

      <!-- Annotation -->
      <text x="460" y="278" text-anchor="middle" fill="#6b6b80" font-size="10" font-family="JetBrains Mono, monospace">docs → feat → fix → test — the loop repeats weekly</text>
    </svg>
  </div>
  <p class="dim center" style="font-size: 0.85rem;">Every peak tells a story — <span class="bold" style="color:#FF6B6B;">red waves</span> are the debug phase catching up to <span class="bold" style="color:#5BF58C;">green builds</span>.</p>
</div>`,
...
// ═══════════════════════════════════════════════════════
`<div>
  <h2><span class="accent" style="color: #c084fc;">Document</span> — Phase 1</h2>
  <p class="dim mb-2">Spec before you ship. Every feature starts with a PRD.</p>
  <div class="two-col">
    <div>
      <h3 style="color: #c084fc;">/new-feature Workflow</h3>
...
// ═══════════════════════════════════════════════════════
`<div>
  <h2><span class="accent" style="color: #4ade80;">Implement</span> — Phase 2</h2>
  <p class="dim mb-2">Agent orchestra builds the feature in phased delivery</p>
  <div class="two-col">
    <div>
      <h3 style="color: #4ade80;">Phased Delivery</h3>
      <div class="tier-stack">
        <div class="tier" style="border-color: #4ade80;">
          <div class="tier-num" style="background: #4ade80;">C1</div>
          <div>
        ...
        <div class="tier" style="border-color: #4ade80;">
          <div class="tier-num" style="background: #4ade80;">C2</div>
          <div>
        ...
        <div class="tier" style="border-color: #4ade80;">
          <div class="tier-num" style="background: #4ade80;">D1</div>
          <div>
        ...
        <div class="tier" style="border-color: #4ade80;">
          <div class="tier-num" style="background: #4ade80;">D2</div>
          <div>
...
// ═══════════════════════════════════════════════════════
`<div>
  <h2><span class="accent" style="color: #f87171;">Debug / Verify</span> — Phase 3</h2>
...
// ═══════════════════════════════════════════════════════
`<div>
  <h2><span class="accent" style="color: #22d3ee;">Test</span> — Phase 4</h2>
  <p class="dim mb-2">The gate before repeat. Verify first, then codify into tests.</p>
  <div class="two-col">
    <div>
      <h3 style="color: #22d3ee;">Test-After-Verify Pattern</h3>
      ...
      <div class="tier-stack mt-2">
        <div class="tier" style="border-color: #22d3ee;">
          <div class="tier-num" style="background: #22d3ee;">1</div>
          <div>
        ...
        <div class="tier" style="border-color: #22d3ee;">
          <div class="tier-num" style="background: #22d3ee;">2</div>
          <div>
        ...
        <div class="tier" style="border-color: #22d3ee;">
          <div class="tier-num" style="background: #22d3ee;">3</div>
          <div>
...
`<div>
  ...
  <div class="two-col">
    <ol class="insight-list">
      <li><span class="bold" style="color:#c084fc;">Document first.</span> A PRD takes 10 minutes. A wrong implementation takes 3 days. Spec before you ship.</li>
    ...
    <ol class="insight-list" start="6">
      <li><span class="bold" style="color:#c084fc;">Multi-model debugging.</span> Consult multiple models in parallel. Different perspectives find different bugs.</li>
...
`<div class="section-divider">
  ...
  <div class="stat-grid mt-3" style="max-width: 400px;">
    <div class="stat">
